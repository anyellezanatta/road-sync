...
ride1 = Ride.create!(origin: "Arnhem", destination: "Schipol",  origin_address: "Fortunastraat 34, 6846XZ Arnhem", destination_address: "Aankomstpassage 1, 1118 AX Schiphol", date: Date.new(2024, 6, 17), start_time: "12:00",
...
ride3 = Ride.create!(origin: "Rotterdam", destination: "Delft",  origin_address: "Coolsingel 44, 3011 AD Rotterdam", destination_address: "Kleveringweg 2, 2616 LZ Delft", date: Date.new(2024, 6, 17), start_time: "10:00",
                    remarks: "No food allowed", price_per_km: 0.7, seats: 3, driver: driverMatilda)
ride4 = Ride.create!(origin: "Utrecht", destination: "Rotterdam",  origin_address: "Lange Viestraat 3, 3511 BK Utrecht", destination_address: "Coolsingel 44, 3011 AD Rotterdam", date: Date.new(2024, 6, 17), start_time: "16:00",
...
# Additional bookings
# Booking.create(ride: ride2, user: parikaya, status: "confirmed", seats: 1, origin: "Nieuwegein", origin_address: "Nieuwegein City Plaza, 3431 Nieuwegein", destination: "Amsterdam", destination_address: "Amsterdam Amstel Station, 1097 Amsterdam")
# Booking.create(ride: ride2, user: , status: "confirmed", seats: 1, origin: "Houten", origin_address: "Houten Station, 3991 Houten", destination: "Amsterdam", destination_address: "Amsterdam Zuid Station, 1077 Amsterdam")
# Booking.create(ride: ride6, user: marie, status: "confirmed", seats: 1, origin: "Amsterdam", origin_address: "Van Gogh Museum, Museumplein 6, 1071 DJ Amsterdam", destination: "Arnhem", destination_address: "Burgers' Zoo, Antoon van Hooffplein 1, 6816 SH Arnhem")
# Booking.create(ride: ride6, user: marie, status: "confirmed", seats: 1, origin: "Amsterdam", origin_address: "Amsterdam Centraal, Stationsplein, 1012 AB Amsterdam", destination: "Arnhem", destination_address: "Korenmarkt, 6811 GV Arnhem")
...
review6 = Review.create!(comment: "Marie was professional and the car was in good condition. However, he arrived a few minutes late and the route he took had heavy traffic. It would be great if he could plan for traffic better next time.", rating: 4, booking: booking6, reviewer: parikaya, receiver: marie)

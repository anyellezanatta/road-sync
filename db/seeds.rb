...
review2 = Review.create!(
  comment: "Parikaya provided a fantastic experience! He was friendly and professional, ensuring that all my needs were met during the trip from Utrecht to Amsterdam. The car was spotless and the ride was very comfortable. I would definitely book with her again.", rating: 5, booking: booking2, reviewer: anyelle, receiver: parikaya
)
...
review6 = Review.create!(
  comment: "Marie was professional and the car was in good condition. However, he arrived a few minutes late and the route he took had heavy traffic. It would be great if he could plan for traffic better next time.", rating: 4, booking: booking6, reviewer: parikaya, receiver: marie
)

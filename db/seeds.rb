...
ride13 = Ride.create!(origin: "Eindhoven", destination: "Zaandaam",
                      origin_address: "Aalsterweg 322, 5644 RL Eindhoven", destination_address: "Ebbehout 22, 1507 EA Zaandam", date: Date.new(2024, 6, 17), start_time: "06:00", remarks: "No loud music allowed", price_per_km: 0.8, seats: 3, driver: driverMarie)
